//The following code is done based on the following repositry,
//URL:https://github.com/claireellul/cegeg077-week5server/blob/master/httpServer.js
...
app.use(bodyParser.urlencoded({
  extended: true //Support parsing of application from URLencoded post data
}));
...
var querystring = "INSERT into useranswers (requiredquestion,answer,useranswer) values ('"; //Saving the question, correct answer and user answer into "useranswers"
querystring = querystring + req.body.requiredquestion + "','" + req.body.answer + "','"; //adding the question and correct answer
querystring = querystring  + req.body.useranswer+"')"; //adding the user answer
       	console.log(querystring); //this shows the querystring on the console screen
          ...
          res.status(200).send("row inserted"); //To show the user that the information has been stored in the database table
       });
    });
...
//just a test to check the connection to data bases of ""united_kingdom_counties" table
